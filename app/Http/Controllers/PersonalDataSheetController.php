...
class PersonalDataSheetController extends Controller
{
    ...
    public function store(StorePersonalInformationRequest $request)
    {
        ...
        //  $personalInformationRequestExist = PersonalInformation::where([['mobile_number', $request->mobile_number],
        ...
        //   ['birthdate', $request->birthdate]])->exists();
    

        //  if ($personalInformationRequestExist) {
