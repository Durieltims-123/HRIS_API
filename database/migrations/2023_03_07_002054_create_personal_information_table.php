...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('personal_information', function (Blueprint $table) {
            ...
            $table->foreignId('permanent_barangay_id');
            ...
            $table->foreignId('residential_barangay_id');

            $table->foreignId('residential_municipality_id');

            $table->foreignId('residential_province_id');
